...
import com.sapient.banking_service.controller.BankController;
...
public class BankAccountTests {
    ...
    public void testAllArgsConstructor() {
        ...
        // Act
        BankAccount bankAccount = new BankAccount(bankId, accountNumber, balance, user, accountTypes);

        // Assert
        assertNotNull(bankAccount);
        assertEquals(bankId, bankAccount.getBankId());
        ...
        assertEquals(accountTypes, bankAccount.getAccountTypes());
    }
    ...
    @Test
    public void testNoArgsConstructorInitialization() {
        // Arrange & Act
        BankAccount bankAccount = new BankAccount();
...
//    @Test
//    public void testTransfer_AccountNotFound() throws AccountNotFoundException {
//        // Arrange
//        Integer userId = 1;
//        AccountTypes transferAcc = AccountTypes.SAVINGS;
//        AccountTypes beneficialAcc = AccountTypes.PF;
//        double amount = 100.0;
//        String errorMessage = "Account not found for user ID: " + userId + " and account type: ";
//
//        when(bankService.transfer(userId, transferAcc, beneficialAcc, amount)).thenThrow(new AccountNotFoundException(errorMessage + transferAcc));
//
//        // Act
//        ResponseEntity<Object> responseEntity = bankController.transfer(userId, transferAcc, beneficialAcc, amount);
//
//        // Assert
//        assertEquals(HttpStatus.BAD_REQUEST, responseEntity.getStatusCode());
//        assertEquals("Transaction Failure: " + errorMessage + transferAcc, responseEntity.getBody());
//
//        verify(bankService, times(1)).transfer(userId, transferAcc, beneficialAcc, amount);
//    }
//
//    @Test
//    public void testTransfer_InsufficientFunds() throws AccountNotFoundException {
//        // Arrange
//        Integer userId = 1;
//        AccountTypes transferAcc = AccountTypes.SAVINGS;
//        AccountTypes beneficialAcc = AccountTypes.PF;
...
//        String errorMessage = "Insufficient funds";
//
//        when(bankService.transfer(userId, transferAcc, beneficialAcc, amount)).thenThrow(new InsufficientFundsException(errorMessage));
//
//        // Act
//        ResponseEntity<Object> responseEntity = bankController.transfer(userId, transferAcc, beneficialAcc, amount);
//
//        // Assert
//        assertEquals(HttpStatus.INTERNAL_SERVER_ERROR, responseEntity.getStatusCode());
//        assertEquals("Transaction Failure: " + errorMessage, responseEntity.getBody());
//
//        verify(bankService, times(1)).transfer(userId, transferAcc, beneficialAcc, amount);
//    }
